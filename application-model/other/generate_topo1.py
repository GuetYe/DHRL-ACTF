...
def parse_xml_topology(topology_path):
    ...
    for child in topo_element.iter():
        ...
        if child.tag == 'node':
            ...
            locationsta = str(child.find('locationap').get('coordinate'))
...
class Nodes14Topo():
    ...
    def topology(self, args):
        ...
        for l in self.edges_pairs:
            ...
            links_info.setdefault(l, {"port1": port1, "port2": port2, "bw": _bw, "delay": _d, "loss": _l, "distance": _distance})
...
if __name__ == "__main__":
    xml_topology_path = r'topologies/topology4.xml'
    links_info_xml_path = r'links_info/links_info4.xml'
    iperf_path = "./iperfTM"
    iperf_interval = 0
