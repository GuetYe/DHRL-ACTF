...
class PropagationModel(object):
    ...
    def logDistance(self, intf, ap_intf, dist):
        ...
        calculated
        exponent: The exponent of the route Loss propagation model, where 2
    ...
    def ITU(self, intf, ap_intf, dist):
        ...
        Site-Specific Validation of ITU Indoor route Loss Model at 2.4 GHz 
...
class SetSignalRange(object):
    ...
    def logDistance(self, intf):
        ...
        ref_d (m): The distance at which the reference loss is
        calculated
        exponent: The exponent of the route Loss propagation model, where 2 is
